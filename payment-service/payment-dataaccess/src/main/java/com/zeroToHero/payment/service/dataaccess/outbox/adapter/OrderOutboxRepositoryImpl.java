package com.zeroToHero.payment.service.dataaccess.outbox.adapter;

import com.zeroToHero.domain.valueobject.PaymentStatus;
import com.zeroToHero.outbox.OutboxStatus;
import com.zeroToHero.payment.service.dataaccess.outbox.exception.OrderOutboxNotFoundException;
import com.zeroToHero.payment.service.dataaccess.outbox.mapper.OrderOutboxDataAccessMapper;
import com.zeroToHero.payment.service.dataaccess.outbox.repository.OrderOutboxJpaRepository;
import com.zeroToHero.payment.service.domain.outbox.model.OrderOutboxMessage;
import com.zeroToHero.payment.service.domain.ports.output.repository.OrderOutboxRepository;
