package com.zeroToHero.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.zeroToHero.outbox.OutboxStatus;
import com.zeroToHero.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.zeroToHero.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.zeroToHero.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.zeroToHero.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.zeroToHero.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
