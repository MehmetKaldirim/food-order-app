package com.zeroToHero.order.service.dataaccess.outbox.restaurantapproval.adapter;

import com.zeroToHero.order.service.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import com.zeroToHero.order.service.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
import com.zeroToHero.order.service.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import com.zeroToHero.order.service.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import com.zeroToHero.order.service.domain.ports.output.repository.ApprovalOutboxRepository;
