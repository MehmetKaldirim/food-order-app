package com.zeroToHero.order.service.dataaccess.outbox.payment.adapter;

import com.zeroToHero.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import com.zeroToHero.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import com.zeroToHero.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import com.zeroToHero.order.service.domain.outbox.model.payment.OrderPaymentOutboxMessage;
import com.zeroToHero.order.service.domain.ports.output.repository.PaymentOutboxRepository;
